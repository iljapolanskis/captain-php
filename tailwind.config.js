...
module.exports = {
    ...
    theme: {
        ...
        borderColor: ({theme}) => ({
            ...theme('colors'), DEFAULT: theme('colors.gray.200', 'currentColor'),
        }),
        ...
        maxWidth: ({theme, breakpoints}) => ({
            ...
            max: 'max-content',
            fit: 'fit-content',
            prose: '65ch', ...breakpoints(theme('screens')),
        }),
        minHeight: {
        ...
        ringColor: ({theme}) => ({
            DEFAULT: theme('colors.blue.500', '#3b82f6'), ...theme('colors'),
        }),
